...
{\filleft\colorbox{Guinda}{\color{white}\quad\fontsize{48}{48}\selectfont\thechapter\quad}\vspace{2pt}\color{Guinda}\titlerule[3pt]}
{0.5em}
{\filright\color{NavyBlue}}[\vspace{4pt}\color{Guinda}\titlerule[1.5pt]\vspace{6pt}]

\titlespacing{\chapter}{0pt}{-20pt}{20pt}

\titleformat{\section}
{\normalfont\large\bfseries\color{NavyBlue}}
{\colorbox{NavyBlue}{\color{white}\;\thesection\;}}{0.7em}{}[\color{Guinda}\titlerule[0.8pt]\vspace{2pt}]

\titlespacing{\section}{0pt}{14pt}{8pt}

\titleformat{\subsection}
{\normalfont\normalsize\bfseries\color{Guinda}}
{\thesubsection\;}{0.5em}{}[\color{NavyBlue!30}\titlerule[0.4pt]]
